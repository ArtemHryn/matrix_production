      ...
      info: [
        {
          ...
          energyInfo: [
            ...
            {
              name:
                lng === "ua" ? "Натхнення та дії" : "Вдохновение и действия",
      ...
      info: [
        {
          type:
            lng === "ua"
              ? "Трикутник земного володіння"
              : "Треугольник земного обладания",
          energyInfo: [
            {
        ...
        },
        {
          type:
            lng === "ua"
              ? "Трикутник почестей та слави"
              : "Треугольник почестей и славы",
          energyInfo: [
            {
              name:
                lng === "ua" ? "Карма особистості, его" : "Карма личности, эго",
              energy: day,
            },
            {
              name: "Слава",
            ...
            },
            {
              name:
                lng === "ua"
                  ? "Платформа почестей та слави"
                  : "Платформа почестей и славы",
