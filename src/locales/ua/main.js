const mainUa = {
  projectText:
    "Консультант із причинно-наслідкових зв’язків та майстер Матриці Долі",
  heroChoose: "Більше жодних сумнівів у собі та «магії» власних дій.",
  heroButton1: "Перейти до послуг",
  heroButton2: "Калькулятор матриці",
  projectAuthor: "Освіта",
  authroDesc:
    "<0>Дарина Дупак</0> — Професійний ініційований консультант із призначення, діагностики та корекції долі.",
  aboutAuthorWork1: "Дипломований менеджер соціокультурної діяльності",
  aboutAuthorWork2:
    "Проводжу трансформаційні івенти. Працюю над створенням особистісних брендів.",
  aboutAuthorWork3:
    "Працюю за авторським методом Наталії Ладіні, відомого як Матриця Долі.",
  aboutAuthorWork4:
    "Володію поглибленими розрахунками методу і техніками зцілення.",
  aboutAuthorWork5:
  ...
  matrixMinusAndPlusCheckboxText: "Пропрацювати матрицю",
  matrxiMinusPuzzle: "постаєш перед фінансовими труднощами",
  waysToTransformationTitle: "Я проведу тебе до істинних бажань твоєї душі.",
  waysToTransformationAbout:
    "Ти не залишишся наодинці з багажем нової інформації про себе, оскільки я гарантую:",
  waysToTransformationWarning:
    "*Необережне відкриття доленосних програм, без готовності працювати над ними, може мати негативні наслідки. Тому для вашої безпеки всі повноцінні консультації по матриці НЕ проводяться без готовності клієнта йти до трансформації.",
  waysToTransformationConsultationTitle: "На  Консультації",
  waysToTransformationConsultationText1:
    "Індивідуальний підхід до кожного клієнта",
  waysToTransformationConsultationText2:
    "Унікальні інтерпретації зв'язків енергій у твоїй матриці",
  waysToTransformationConsultationText3:
    "Інформацію, яка з часом розкриється на новому, глибинному рівні",
  waysToTransformationTransformationWayTitle: "На  Трансформації",
  waysToTransformationTransformationWayText1:
    "Енергетичну та інформаційну підтримку",
  waysToTransformationTransformationWayText2:
    "Надання комплексу рекомендацій та матеріалів - кармічний рецепт",
  waysToTransformationTransformationWayText3:
    "Різноманітні методики та практики",
